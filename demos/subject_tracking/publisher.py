...
class PosePublisher:
    def __init__(self):
        ...
        self.annotated_pub = rospy.Publisher(
            '/subject_tracker/image_annotated', Image, queue_size=1
        )
        self.landmarks_pub = rospy.Publisher(
            '/subject_tracker/landmarks', String, queue_size=10
        )

        rospy.loginfo('[PosePublisher] ready — publishing to /subject_tracker/')
