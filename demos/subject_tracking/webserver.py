...
Subscribes to /subject_tracker/landmarks and /subject_tracker/image_annotated published
...
def ros_main():
    ...
    rospy.Subscriber('/subject_tracker/landmarks', String, landmarks_cb)
    rospy.Subscriber('/subject_tracker/image_annotated', Image, image_cb)
    rospy.loginfo('[WebServer] subscribed to /subject_tracker/ topics')
    rospy.spin()
