...
HEAD_DOWN_PULSE = {
    ...
    'l_el_yaw':    150,  'r_el_yaw':    850,
    'l_gripper':   500,  'r_gripper':   500,
    'head_pan':    500,  'head_tilt':   400,
}

HEAD_DOWN_RIGHT_PULSE = {
    'l_ank_roll':  500,  'r_ank_roll':  500,
    'l_ank_pitch': 640,  'r_ank_pitch': 360,
    'l_knee':      500,  'r_knee':      500,
    'l_hip_pitch': 350,  'r_hip_pitch': 650,
...
HEAD_UP_LEFT_PULSE = {
    ...
    'l_el_yaw':    150,  'r_el_yaw':    850,
    'l_gripper':   500,  'r_gripper':   500,
    'head_pan':    700,  'head_tilt':   600,
}

HEAD_DOWN_LEFT_PULSE = {
    'l_ank_roll':  500,  'r_ank_roll':  500,
    'l_ank_pitch': 640,  'r_ank_pitch': 360,
    'l_knee':      500,  'r_knee':      500,
    'l_hip_pitch': 350,  'r_hip_pitch': 650,
...
class DemoPose():
    ...
    def run(self):
        ...
        time.sleep(2.0)
        self._execute_cmd(HEAD_DOWN_RIGHT_PULSE)
        time.sleep(2.0)
        self._execute_cmd(HEAD_UP_RIGHT_PULSE)
        time.sleep(2.0)
        self._execute_cmd(HEAD_DOWN_LEFT_PULSE)
        time.sleep(2.0)
        self._execute_cmd(HEAD_UP_LEFT_PULSE)
